...
#define NXPLOG_FUNC_ENTRY(COMP)                                                \
  phOsalNfc_Log_pri(ANDROID_LOG_VERBOSE, (COMP), "+:%s", (__func__))
...
#define NXPLOG_EXTNS_D(...)                                                    \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
      ...
      phOsalNfc_Log_pri(ANDROID_LOG_DEBUG, NXPLOG_ITEM_EXTNS, __VA_ARGS__);    \
  }
#define NXPLOG_EXTNS_W(...)                                                    \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
        (gLog_level.extns_log_level >= NXPLOG_LOG_WARN_LOGLEVEL))              \
      phOsalNfc_Log_pri(ANDROID_LOG_WARN, NXPLOG_ITEM_EXTNS, __VA_ARGS__);     \
  }
#define NXPLOG_EXTNS_E(...)                                                    \
  {                                                                            \
    if (gLog_level.extns_log_level >= NXPLOG_LOG_ERROR_LOGLEVEL)               \
      phOsalNfc_Log_pri(ANDROID_LOG_ERROR, NXPLOG_ITEM_EXTNS, __VA_ARGS__);    \
  }
#else
#define NXPLOG_EXTNS_D(...)
#define NXPLOG_EXTNS_W(...)
...
#define NXPLOG_NCIHAL_D(...)                                                   \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
      ...
      phOsalNfc_Log_pri(ANDROID_LOG_DEBUG, NXPLOG_ITEM_NCIHAL, __VA_ARGS__);   \
  }
#define NXPLOG_NCIHAL_W(...)                                                   \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
        (gLog_level.hal_log_level >= NXPLOG_LOG_WARN_LOGLEVEL))                \
      phOsalNfc_Log_pri(ANDROID_LOG_WARN, NXPLOG_ITEM_NCIHAL, __VA_ARGS__);    \
  }
#define NXPLOG_NCIHAL_E(...)                                                   \
  {                                                                            \
    if (gLog_level.hal_log_level >= NXPLOG_LOG_ERROR_LOGLEVEL)                 \
      phOsalNfc_Log_pri(ANDROID_LOG_ERROR, NXPLOG_ITEM_NCIHAL, __VA_ARGS__);   \
  }
#else
#define NXPLOG_NCIHAL_D(...)
#define NXPLOG_NCIHAL_W(...)
...
#define NXPLOG_NCIX_D(...)                                                     \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
      ...
      phOsalNfc_Log_pri(ANDROID_LOG_DEBUG, NXPLOG_ITEM_NCIX, __VA_ARGS__);     \
  }
#define NXPLOG_NCIX_W(...)                                                     \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
        (gLog_level.ncix_log_level >= NXPLOG_LOG_WARN_LOGLEVEL))               \
      phOsalNfc_Log_pri(ANDROID_LOG_WARN, NXPLOG_ITEM_NCIX, __VA_ARGS__);      \
  }
#define NXPLOG_NCIX_E(...)                                                     \
  {                                                                            \
    if (gLog_level.ncix_log_level >= NXPLOG_LOG_ERROR_LOGLEVEL)                \
      phOsalNfc_Log_pri(ANDROID_LOG_ERROR, NXPLOG_ITEM_NCIX, __VA_ARGS__);     \
  }
#else
#define NXPLOG_NCIX_D(...)
#define NXPLOG_NCIX_W(...)
...
#define NXPLOG_NCIR_D(...)                                                     \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
      ...
      phOsalNfc_Log_pri(ANDROID_LOG_DEBUG, NXPLOG_ITEM_NCIR, __VA_ARGS__);     \
  }
#define NXPLOG_NCIR_W(...)                                                     \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
        (gLog_level.ncir_log_level >= NXPLOG_LOG_WARN_LOGLEVEL))               \
      phOsalNfc_Log_pri(ANDROID_LOG_WARN, NXPLOG_ITEM_NCIR, __VA_ARGS__);      \
  }
#define NXPLOG_NCIR_E(...)                                                     \
  {                                                                            \
    if (gLog_level.ncir_log_level >= NXPLOG_LOG_ERROR_LOGLEVEL)                \
      phOsalNfc_Log_pri(ANDROID_LOG_ERROR, NXPLOG_ITEM_NCIR, __VA_ARGS__);     \
  }
#else
#define NXPLOG_NCIR_D(...)
#define NXPLOG_NCIR_W(...)
...
#define NXPLOG_FWDNLD_D(...)                                                   \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
      ...
      phOsalNfc_Log_pri(ANDROID_LOG_DEBUG, NXPLOG_ITEM_FWDNLD, __VA_ARGS__);   \
  }
#define NXPLOG_FWDNLD_W(...)                                                   \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
        (gLog_level.dnld_log_level >= NXPLOG_LOG_WARN_LOGLEVEL))               \
      phOsalNfc_Log_pri(ANDROID_LOG_WARN, NXPLOG_ITEM_FWDNLD, __VA_ARGS__);    \
  }
#define NXPLOG_FWDNLD_E(...)                                                   \
  {                                                                            \
    if (gLog_level.dnld_log_level >= NXPLOG_LOG_ERROR_LOGLEVEL)                \
      phOsalNfc_Log_pri(ANDROID_LOG_ERROR, NXPLOG_ITEM_FWDNLD, __VA_ARGS__);   \
  }
#else
#define NXPLOG_FWDNLD_D(...)
#define NXPLOG_FWDNLD_W(...)
...
#define NXPLOG_TML_D(...)                                                      \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
      ...
      phOsalNfc_Log_pri(ANDROID_LOG_DEBUG, NXPLOG_ITEM_TML, __VA_ARGS__);      \
  }
#define NXPLOG_TML_W(...)                                                      \
  {                                                                            \
    if ((nfc_debug_enabled) ||                                                 \
        (gLog_level.tml_log_level >= NXPLOG_LOG_WARN_LOGLEVEL))                \
      phOsalNfc_Log_pri(ANDROID_LOG_WARN, NXPLOG_ITEM_TML, __VA_ARGS__);       \
  }
#define NXPLOG_TML_E(...)                                                      \
  {                                                                            \
    if (gLog_level.tml_log_level >= NXPLOG_LOG_ERROR_LOGLEVEL)                 \
      phOsalNfc_Log_pri(ANDROID_LOG_ERROR, NXPLOG_ITEM_TML, __VA_ARGS__);      \
  }
#else
#define NXPLOG_TML_D(...)
#define NXPLOG_TML_W(...)
