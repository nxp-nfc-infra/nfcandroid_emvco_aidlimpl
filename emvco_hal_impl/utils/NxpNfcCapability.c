...
/*Init Response*/
static const uint16_t offsetInitHwVersion = 24;
static const uint16_t offsetInitFwVersion = 25;
/*Reset Notification*/
static const uint16_t offsetRstHwVersion = 8;
static const uint16_t offsetRstFwVersion = 9;
/*Propreitary Response*/
static const uint16_t offsetPropHwVersion = 3;
static const uint16_t offsetPropFwVersion = 4;

/*product[] will be used to print product version and
should be kept in accordance with tNFC_chipType*/
static const char *product[11] = {"UNKNOWN", "PN547C2", "PN65T", "PN548C2",
                                  "PN66T",   "PN551",   "PN67T", "PN553",
                                  "PN80T",   "PN557",   "PN81T"};
static tNFC_chipType chipType = pn81T;
